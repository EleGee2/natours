...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFwaWpheSIsImEiOiJja2FlOW5temgwM3R3MnpzOTBicTR6MW9qIn0.fdCMj5C_S7fVDM9YtJMTnw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/papijay/ckaeas2r50ch01irptjgdik3n',
    scrollZoom: false
  });
...
var confirm_password = document.getElementById('confirm_password'); //password.onchange = validatePassword;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "If we found an account associated with that username, we've sent password reset instructions to the primary email address on the account");
            }
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, tourID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_51GswiCDiQNJCFZtSUfkni64CrAN8bpU86wlhNc4D82GP4cjYuYA9KNMtluIVA2qPChBihs8Bp9KoEtl9rqTTyL6x00fEWB7o4n');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2. Create checkout form plus charge the credit card for us
...
var logOutBtn = document.querySelector('.nav__e--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var forgotPasswordBtn = document.querySelector('.resetpassword-form');
var bookBtn = document.getElementById('book-tour');
var rev = document.getElementById('reviewss');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  e.preventDefault(); //document.querySelector('.btn-signup').innerHTML = 'Signing..'
...
if (reviewBtn) reviewBtn.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            tourID = rev.getAttributeNode("data-tour-id").value;
