...
const tourSchema = new mongoose.Schema(
  {
    ...
    duration: { type: Number, required: 'A tour must have a duration' },
    maxGroupSize: { type: Number, required: 'A tour must have a maxGroupSize' },
    difficulty: {
      type: String,
...
/*'8tourSchema.pre('aggregate', function (next) {
